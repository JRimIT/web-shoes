            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 order-md-2 mb-4">
                        ...
                        %>
                        <!-- BILLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL -->
                    </div>
                    <div class="col-md-8 order-md-1">
                        <h4 class="mb-3">Billing address</h4>

                        <form action="CheckOutServlet" method="post" class="needs-validation" novalidate>
                            <div class="row">
                            ...
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input id="delivery" name="PaymentMethod" type="radio" class="custom-control-input"value="Payment on delivery" checked required>
                                    <label class="custom-control-label" for="delivery">Payment on delivery</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input id="card" name="PaymentMethod" type="radio" class="custom-control-input" value="Payment by card" required>
                                    <label class="custom-control-label" for="card">Payment by card</label>
                                </div>                                                       
                            </div>
